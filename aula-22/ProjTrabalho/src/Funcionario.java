public class Funcionario {
    ...
    public double somarDesconto(){
        return this.calcularInss()+this.calcularValeRefeicao()+this.calcularValeTransporte();
    }
    public double somarBeneficios(){
        return this.calcularInsalubridade()+this.calcularTotalHorasExras()+this.calcularSalarioFamilia();
    }
    public double calcularSalarioLiquido(){
        return this.calcularSalarioBruto()+this.somarBeneficios()-this.somarDesconto();
    }
